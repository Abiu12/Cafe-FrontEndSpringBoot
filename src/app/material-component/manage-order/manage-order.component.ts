...
export class ManageOrderComponent implements OnInit {
  ...
  setQuantity(value:any){
    ...
    if(temp > 0){
      console.log("setee con",temp);
      var total = this.manageOrderForm.controls['quantity'].value * this.manageOrderForm.controls['price'].value
      console.log(total);
      ...
      this.manageOrderForm.controls['quantity'].setValue('1');
      this.manageOrderForm.control['total'].setValue(this.manageOrderForm.controls['quantity'].value * this.manageOrderForm.controls['price'].value );
    }
  }
